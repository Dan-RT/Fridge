...
//type Props = {};
export default class BarCodMenu extends React.Component<props> {
  constructor(props){
    super(props);
  ...
  //cehck out freecodecamp.org: understanding state in react
  onBarCodeRead(scan){
    ...
    if (scan.data!=null){
      ...
      if (this.state.isAdding){
        this.props.navigation.navigate('ItemAddition', {bcode:this.state.bcode})

      } else {
        alert("deleting this code to DB" + this.state.bcode);
        this.props.navigation.navigate('ItemRemoval', {bcode:this.state.bcode})
      }
