...
import { getDeleteQuantityIngredient } from '../API/FoodAPI'
...
export default class ItemRemoval extends React.Component {
  ...
  // Handler methods
  onSubmit = () =>{
    getDeleteQuantityIngredient(token, this.state.bcode, this.state.quantity);

    ToastAndroid.show("Item enlevé: " + this.state.bcode + " quantité:" + this.state.quantity)
